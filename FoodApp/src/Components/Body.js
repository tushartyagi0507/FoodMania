  ...
  return listofRestaurants?.length === 0 ? (
    ...
    <div className="body">
      ...
      >
        ...
        <div
          className="mr-10 mt-4 text-center
          md:mt-0"
        >
          <input
            type="text"
      ...
      <h1
        className="text-lg ml-[12%] font-bold my-6 
        sm:text-xl
        md:text-2xl
        lg:ml-44 lg:text-3xl"
      >
        What's on your mind?
      </h1>
      <div
      ...
      <h1
        className="my-6 ml-[12%] font-bold text-lg
        sm:text-xl
        md:text-2xl
        lg:text-3xl lg:ml-44"
      >
        Top Resaturants in Bangalore
      </h1>
      <div
